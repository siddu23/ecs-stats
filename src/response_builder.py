...
def for_user_feed(kwargs):
    ...
    for pratilipi in pratilipis:
        ...
        response_pratilipi = _set_key(response_pratilipi, 'slug', "/story/" + pratilipi.slug + "-" + pratilipi.slug_id)
        response_pratilipi = _set_key(response_pratilipi, 'slugEn', "/story/" + pratilipi.slug_en + "-" + pratilipi.slug_id)
